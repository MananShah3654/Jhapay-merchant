      ...
      <div className="px-5 mt-3">
        ...
        <div className="grid grid-cols-2 gap-2.5 jh-stagger">
          <Card className="p-4" testid="stat-customers">
            <div className="text-[11px] text-[color:var(--jh-text-2)] font-medium">Total customers</div>
            <div className="jh-num text-[24px] font-bold text-[color:var(--jh-text)] mt-1">
              {customers.length}
            </div>
            <div className="text-[10px] text-[color:var(--jh-primary)] font-semibold mt-1">
              +3 this week
            </div>
          </Card>
          <Card className="p-4" testid="stat-ltv">
            <div className="text-[11px] text-[color:var(--jh-text-2)] font-medium">Lifetime value</div>
            <div className="jh-num text-[24px] font-bold text-[color:var(--jh-text)] mt-1">
              {currency(totalLTV)}
            </div>
            <div className="text-[10px] text-[color:var(--jh-primary)] font-semibold mt-1">
        ...
        <Card className="mt-3 overflow-hidden" testid="customers-list">
            ...
            <div key={c.id} className={i < arr.length - 1 ? "jh-hairline" : ""}>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5">
                    ...
                    {c.tags.includes("VIP") && (
                      <Star size={11} color="var(--jh-warning)" fill="var(--jh-warning)" />
                    )}
                  </div>
                ...
                <div className="text-right">
                  <div className="jh-num text-[13px] font-semibold text-[color:var(--jh-text)]">
                    {currency(c.ltv)}
                  </div>
                  <div className="text-[10px] text-[color:var(--jh-text-3)]">lifetime</div>
                </div>
              ...
              {active === c.id && (
                <div className="px-4 pb-4 jh-fade-in" data-testid={`customer-detail-${c.id}`}>
                  ...
                  >
                    <button
                      className="h-10 rounded-[12px] inline-flex items-center justify-center gap-1 jh-press text-[12px] font-semibold text-[color:var(--jh-text)]"
          ...
          {filtered.length === 0 && (
            <div className="text-center text-[13px] text-[color:var(--jh-text-2)] py-10">
              No customers match.
            </div>
          )}
        </Card>
